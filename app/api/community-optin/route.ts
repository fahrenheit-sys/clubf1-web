...
async function sendMetaLead(args: {
  ...
  const payload: Record<string, unknown> = {
    data: [{
      ...
      event_source_url: 'https://www.clubf1.com.au/community',
      user_data,
      custom_data: { content_name: 'community opt-in' },
    }],
  }
...
export async function POST(req: NextRequest) {
  ...
  const tags = ['track::community', 'source::opt-in-form', `type::${membershipInterest.toLowerCase()}`]
  ...
  try {
        ...
        body: JSON.stringify({
          ...
          contact: {
            ...
            customField: {
              ...
              is_hakoah_member: isHakoahMember === 'Yes' ? 'Yes' : 'No',
            },
          },
        }),
    ...
    // Meta CAPI — best-effort, non-blocking
