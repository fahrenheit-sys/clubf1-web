...
export const metadata: Metadata = {
  ...
  description:
    "Our community's club. Be one of its founders. A premium fitness and wellness home opening at Hakoah White City, April 2027.",
  robots: { index: false, follow: false }, // targeted community campaign page — not for search
};
